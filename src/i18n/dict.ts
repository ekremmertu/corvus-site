...
export const dict = {
  en: {
    ...
    work: {
      ...
      appStoreSoon: "Coming to iOS",
      screenshots: "From the App Store listing",
      veilSoon: "Coming soon",
      veilConfidential: "Confidential",
      veilNote: "Details hidden until launch",
      veilNoteNda: "Client work under NDA",
      status: "Status",
      year: "Year",
  ...
  tr: {
    ...
    work: {
      ...
      appStoreSoon: "iOS geliyor",
      screenshots: "App Store sayfasından",
      veilSoon: "Yakında",
      veilConfidential: "Gizli",
      veilNote: "Ayrıntılar yayına kadar kapalı",
      veilNoteNda: "Gizlilik sözleşmeli müşteri işi",
      status: "Durum",
      year: "Yıl",
      discipline: "Disiplin",
    },
